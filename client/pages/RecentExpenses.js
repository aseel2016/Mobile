...
color:'grey'}}
      ...
      />
       ...
       <View style={{flexDirection:'row',borderColor:'grey',backgroundColor:'#E2E0E0',borderWidth:0.5,marginHorizontal:10}}>
 
 <Text style={{margin:10,marginTop:15,fontSize:25
   ,fontWeight:'bold',color:'#C70039'}}>Total Income {summ} $</Text>   
...
onPress={handleadd}
  ...
  />
   ...
   <Card style={{marginHorizontal:10,marginVertical:5,backgroundColor:'#66F273'}}>
        ...
        show && <Provider>
          <Portal>
            ...
            onDismiss={()=>setShow(false)} >
              <Text style={{fontSize:25,fontWeight:'bold',margin:20,marginBottom:30,color:'#C70039'}}>➕ New Income</Text>
