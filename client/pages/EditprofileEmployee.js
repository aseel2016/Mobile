...
import { StyleSheet, Text, View,Alert,Dimensions,TouchableOpacity, ImageBackground,TextInput, ScrollView} from 'react-native';
...
let image;
let idRecord;
export default function EditprofileEmployee({navigation,route}){
    ...
    const[extraVa,setExtraVa]=useState(0);
    const[extraWFH,setExtraWEH]=useState(0);
 ...
 */}
 ...
 const response2 = await fetch('http://10.0.2.2:3001/update_oldSalary', {
    method: 'POST',
    headers: {
...
setTeam(teamNew)
setOffice(officeNew)
setExtraVa(extrVactionanew)
setExtraWEH(extraWFHnew)
},[image])
...
return ( 
    <View style={styles.container}>
      ...
      <View style={styles.action }>
      <Icon5 name="money-symbol" color={colors.buttons}  size={30}/>
        <TextInput
          placeholder="Salary"
          value={salary+""}
      ...
      <View style={styles.action }>
      <Icon3 name="group-work"  size={30}/>
      <Picker style={{width:'100%',fontSize:18,marginLeft:10,marginTop:-16}}
 selectedValue={team}
 ...
 onValueChange={(itemValue,itemIndex)=>setOffice(itemValue)}>
   {
     officeBranches.map((val)=>{
      ...
      <View style={styles.action }>
        <Icon5 name="holiday-village" color="black" size={20} />
        <TextInput
          placeholder="Extra vacation"
          value={"Extra Vacation : "+extraVa+" "}
          keyboardType="numeric"
          onChangeText={(Text)=>{setExtraVa(Text)}}
          placeholderTextColor="#666666"
          autoCorrect={false}
          style={[
            styles.textInput,
      ...
      <View style={styles.action }>
        <Icon4 name="home" color="black" size={20} />
        <TextInput
          placeholder="Extra WFH"
          value={ "Extra WFH : "+extraWFH+" "}
          keyboardType="numeric"
          onChangeText={(Text)=>{setExtraWEH(Text)}}
          placeholderTextColor="#666666"
          autoCorrect={false}
          style={[
            styles.textInput,
